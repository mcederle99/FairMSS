    ...
    for seed in range(11):
        ...
        for day in range(100):
            ...
            for time in (0, 1):
                ...
                central_fails += np.sum(failures[155:])
                subcentral_fails += np.sum(failures[135:155])
                per_fails += np.sum(failures[105:135])
        ...
        max_bike_increment = (3950 - initial_bikes) / initial_bikes * 100
...
np.save('results/gini_5_cat.npy', gini_values_tot)
np.save('results/cost_5_cat.npy', costs_tot)
np.save('results/bikes_5_cat.npy', bikes_tot)
np.save('results/max_bikes_5_cat.npy', max_possible_bikes)
