...
np.save('results/gini_5_cat_10seeds_bis.npy', gini_values_tot)
np.save('results/cost_5_cat_10seeds_bis.npy', costs_tot)
np.save('results/cost_reb_5_cat_10seeds_bis.npy', costs_rebalancing)
np.save('results/cost_fail_5_cat_10seeds_bis.npy', costs_failures)
np.save('results/cost_bikes_5_cat_10seeds_bis.npy', costs_bikes)
# np.save('results/increment_bikes_5_cat_10seeds.npy', increment_bikes)
np.save('results/initial_bikes_5_cat_10seeds_bis.npy', initial_bikes)
