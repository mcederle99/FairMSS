...
for s in range(100, 110):
    test_0 = np.load(f'results/learning_curve_5_cat_0.0_{s}.npy')
    test_05 = np.load(f'results/learning_curve_5_cat_0.5_{s}.npy')
    test_1 = np.load(f'results/learning_curve_5_cat_1.0_{s}.npy')
...
if args.save:
    plt.savefig(f"plots/learning_curves_5_cat.pdf", format='pdf')
    plt.savefig(f"plots/learning_curves_5_cat.png", format='png')
